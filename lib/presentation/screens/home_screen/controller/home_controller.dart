...
import 'package:ecommerce/presentation/screens/home_screen/service/home_service.dart';
import 'package:ecommerce/presentation/screens/home_screen/service/res_model/home_screen_res_model.dart';
import 'package:ecommerce/presentation/screens/view_bag_screen/service/res_model/product_res_model.dart';
...
Future<void> getProductListWeb() async {
    ...
    try {
      ///avoids duplicate items
      productList.clear();
      final parsedResData = await HomeScreenService().getProductListWeb();
      if (parsedResData.error != true) {
